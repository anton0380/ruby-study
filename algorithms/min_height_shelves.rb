...
def min_height_shelves(books, shelf_width)
  def find (books, shelf_width, delta)
    min_height = 0
    part_height = 0
    part_width = delta
    books.each do |book|
  ...
  t = []
  (0...shelf_width).each do |delta|
    t.push find(books, shelf_width, delta)
  end 
  t.min
end
...
shelf_width = 4
puts min_height_shelves(books, shelf_width) # 6

books = [[7,3],[8,7],[2,7],[2,5]]
shelf_width = 10
puts min_height_shelves(books, shelf_width) # 17
...
shelf_width = 200
puts min_height_shelves(books, shelf_width) # 15672